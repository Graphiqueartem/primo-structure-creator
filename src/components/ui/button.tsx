...
import { cn } from "@/lib/utils";
  ...
  "inline-flex items-center justify-center gap-2 whitespace-normal break-words text-center leading-snug rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 max-w-full [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        lg: "min-h-14 rounded-xl px-10 py-4 text-lg",
        xl: "min-h-16 rounded-xl px-12 py-5 text-xl",
        icon: "h-12 w-12",
      },
    },
    defaultVariants: {
