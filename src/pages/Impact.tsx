  ...
  return (
    <div className="min-h-screen bg-background pt-14">
      ...
      <section className="py-16 bg-forest-deep text-white">
        <div className="container mx-auto px-4 text-center">
          <p className="text-xl text-ivory/90 max-w-3xl mx-auto mb-6">
          ...
          <p className="text-lg text-ivory/80 max-w-3xl mx-auto mb-12">
      ...
      {/* Impact Overview */}
      <section id="conservation" className="py-16 bg-background">
        <div className="container mx-auto px-4">
            ...
            {metrics.map((metric, index) => (
              <Card key={index} className="text-center hover:shadow-soft transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <div className="text-2xl font-bold text-forest-deep mb-2">
                    {metric.value}
                  </div>
      ...
      {/* Impact Areas */}
      <section id="cultural" className="py-16 bg-forest-light/10">
        <div className="container mx-auto px-4">
          <div className="space-y-12">
            {impactAreas.map((area, index) => (
              <div key={index} className={`${index % 2 === 1 ? 'lg:flex-row-reverse' : ''} flex flex-col lg:flex-row gap-8 items-center`}>
                  ...
                  <Card className={`border-2 ${area.color} shadow-soft`}>
                    <CardContent className="p-8">
                      ...
                      <div className="text-center lg:text-left">
                        <h3 className="text-3xl font-bold text-forest-deep mb-3">
                          {area.title}
                        </h3>
