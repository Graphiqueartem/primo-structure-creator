...
const News = () => {
  ...
  return (
    <div className="min-h-screen bg-background pt-14">
      ...
      {/* Featured Articles */}
      <section id="featured" className="py-16 bg-forest-light/20">
        <div className="container mx-auto px-4">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-ivory/90 mb-8">
              Subscribe to our newsletter for the latest news, behind-the-scenes content, 
              and exclusive insights into our productions and partnerships.
            </p>
            ...
            <Card className="bg-ivory/10 border-ivory/20 max-w-2xl mx-auto">
              <CardContent className="p-8">
                ...
                <div className="grid md:grid-cols-2 gap-4 text-left text-ivory/80 text-sm">
                  <div className="flex items-center gap-2">
                    <Badge variant="secondary">✓</Badge>
                    <span>Weekly updates and insights</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Badge variant="secondary">✓</Badge>
